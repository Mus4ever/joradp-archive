...
REAL_GROUND_TRUTH = {
    ...
    "AR-06": {
        ...
        "lines_ground_truth": [
            "الجريدة الرسمية للجمهورية الجزائرية / العدد 25 28 شوال عام 1413 هـ",
            "مرسوم تشريعي رقم 93 - 05 مؤرخ في 27 شوال عام 1413 الموافق 19 أبريل سنة 1993",
            "المادة 1 : يعدل القانون رقم 90 - 11 المؤرخ في 21 أبريل سنة 1990 والمتعلق بعلاقات العمل",
            "المادة 2 : تعدل أحكام المادة 87 من القانون رقم 90 - 11 المؤرخ في 21 أبريل سنة 1990 وتصاغ كما يأتي :",
            "المادة 87 : يشمل الأجر الوطني الأدنى المضمون الأجر القاعدي والتعويضات والعلاوات",
            "المادة 3 : ينشر هذا المرسوم التشريعي في الجريدة الرسمية للجمهورية الجزائرية الديمقراطية الشعبية",
            "علي كافي",
            "حرر بالجزائر في 19 أبريل سنة 1993",
            "المادة 4 : تلغى جميع الأحكام المخالفة لهذا المرسوم",
            "رئيس المجلس الأعلى للدولة"
        ],
        "key_numbers": ["25", "28", "1413", "93-05", "27", "19", "1993", "1", "90-11", "21", "1990", "87"],
        "columns_expected": 2
    },
    "AR-07": {
        "doc": "AR 1997-027 p.3",
    ...
    "AR-12": {
        ...
        "lines_ground_truth": [
            "4 ربيع الأول عام 1428 هـ الجريدة الرسمية للجمهورية الجزائرية / العدد 19 4",
            "23 مارس سنة 2007 م",
            "للمشروعات المشتركة التي تحقق فوائد ومزايا للدول الأعضاء",
            "المادة 3 : تتعاون الدول الأعضاء في إعداد مختلف الدراسات البترولية والاقتصادية",
            "المادة 4 : يودع صك التصديق على هذه الاتفاقية لدى الأمانة العامة لمنظمة الأقطار العربية المصدرة للبترول",
            "المادة 5 : تنشر هذه الاتفاقية في الجريدة الرسمية للجمهورية الجزائرية الديمقراطية الشعبية",
            "حرر بالجزائر في 21 مارس سنة 2007",
            "عبد العزيز بوتفليقة",
            "المادة 2 : تتولى المنظمة تنسيق السياسات البترولية بين الدول الأعضاء",
            "وزير الشؤون الخارجية"
        ],
        "key_numbers": ["4", "1428", "19", "23", "2007", "3", "4", "5", "21", "2"],
        "columns_expected": 2
    },
    "AR-13": {
        "doc": "AR 2012-001 p.4",
    ...
    "AR-15": {
        ...
        "title": "الجريدة الرسمية / العدد 27",
        "lines_ground_truth": [
            "الجريدة الرسمية للجمهورية الجزائرية / العدد 27 28 رمضان عام 1444 هـ 19 أبريل سنة 2023 م 4",
            "المبلغ المخصص (دج)",
            "العمليات المسجلة",
            "وزارة الأشغال العمومية والمنشآت القاعدية",
            "صيانة الطرق الوطنية والولائية",
            "عصرنة شبكة السكك الحديدية",
            "المنشآت المينائية والمطارات",
            "المجموع العام للاعتمادات المالية المفتوحة",
            "وزير المالية",
            "لعزيز فايد"
        ],
        "key_numbers": ["27", "28", "1444", "19", "2023", "4"],
        "columns_expected": 1
    },
